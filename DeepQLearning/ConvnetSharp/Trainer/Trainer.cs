...
namespace ConvnetSharp
{
    ...
    public class Trainer
    {
        ...
        public Trainer(Net net, Options options)
        {
            ...
            this.learning_rate = options.learning_rate != double.MinValue ? options.learning_rate : 0.01;
            ...
            this.batch_size = options.batch_size != int.MinValue ? options.batch_size : 1;
